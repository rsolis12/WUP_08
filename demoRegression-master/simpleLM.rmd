...
After taken into account all the new results
 ...
 The after taking into acount all the information gathered the Highest to lowest ratings for R squared is model 6 by 0.8463,	then model 2 by 0.791,	followe by model 1  by  0.7524, then model 4 by 7472. lastly  model 3 by 0.5409 and last model 5 by 0.5166.
